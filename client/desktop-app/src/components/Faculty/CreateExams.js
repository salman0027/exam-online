    ...
    render() {
        ...
        if (this.state.uploadedFlag) {
            displayUploadedData.push( <
                ...
                tbody > { data } <
                /tbody> <
                /Table> { /* <Button  onClick={() => this.createExam()} size="lg">Create Exam</Button>{' '} */ }

                <
                FormGroup >
                <
                Label
                for = "formLink" > Form Link < /Label> <
                Input type = "url"
                name = "formLink"
                id = "formLink"
                ...
                <
                /FormGroup> <
                center > < Button color = "success"
                onClick = {
                    () => this.createExam() }
                size = "lg"
                bgcolor = "primary" > Create Exam < /Button></center >
                ...
                /> <
                p style = {
                    { display: this.state.showMessage } } > { this.state.message } < /p> <
                /center>
        ...
        return ( <
            ...
            4. Create a google form < a onClick = {
                () => shell.openExternal("http://forms.google.com/") }
            className = "article" > CLICK HERE < /a><br / >
            5. Add the form link below < br / >
            6. Hit Genearte Exam < br / >
            7. Wait
            for sometime until exam created... < br / >
            <
            /p> <
            /div> <
            /Jumbotron>
            ...
            <
            li > < a onClick = {
                () => shell.openExternal("https://drive.google.com/file/d/1fZ1VETvLAPYCLwkAH4Gtv6Na8-1KGtfN/view?usp=sharing") }
            className = "article" > Download sample document < /a></li >
            <
            div style = {
                { borderStyle: 'dashed' } } > < center > < h3 > Upload File < /h3></center > < input type = "file"
            onChange = { this.fileHandler.bind(this) }
            style = {
                { "padding": "10px" } }
            /></div >
            <
            /ul> { displayUploadedData } <
            /div> <
            /div> <
            /Fragment>
        );
